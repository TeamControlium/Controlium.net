...
namespace TeamControlium.Controlium
{
    public partial class SeleniumDriver
    {
        ...
        public static void SetTestBrowser()
        {
            ...
            string browser;
            if (!TestData.Repository.TryGetItem<string>(ConfigBrowser[0], ConfigBrowser[1], out browser))
            {
                throw new InvalidSettings(string.Format("Error getting setting [{0}],[{1}].", ConfigBrowser[0], ConfigBrowser[1]), TestData.Repository.TryException);
            }
