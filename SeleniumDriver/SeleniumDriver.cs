    ...
    public partial class SeleniumDriver
    {
        ...
        public void SetBrowserSize(string browserSize)
        {
            try
            {
                ...
                {
                    Logger.WriteLine(Logger.LogLevels.TestInformation, $"TestBrowserSize is [{browserSize}] - Setting browser fullscreen");
                ...
                else
                {
                    ...
                    Logger.WriteLine(Logger.LogLevels.TestInformation, $"Browser size (Set by Environment variable [TestBrowserSize]): {browserSize}");
                }
            }
            catch (NullReferenceException)
            {
                Logger.WriteLine(Logger.LogLevels.TestInformation, $"Cannot get TestBrowserSize environment variable (EG. TestBrowserSize [800,600] or [full]). Browser size defaulted to Full Screen.");
                WebDriver.Manage().Window.Maximize();
            }
            catch (Exception ex)
            {
                Logger.WriteLine(Logger.LogLevels.TestInformation, $"Cannot get TestBrowserSize environment variable (EG. TestBrowserSize [800,600] or [full]). Browser size defaulted to Full Screen: {ex}");
                WebDriver.Manage().Window.Maximize();
            }
        }
