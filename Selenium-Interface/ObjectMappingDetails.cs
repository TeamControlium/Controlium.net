...
namespace TeamControlium.Framework
{
    public class ObjectMappingDetails
    {
        ...
        /// </summary>
        /// <example>
        /// <code language="C#" title="Using XPath">
        ///   mappedObject.FindLogic = ".\div[@class='MyClass'];"
        ///   ByType findType = mappedObject.FindType;  // findType equals ByType.XPath
        /// </code>
        /// </example>
        ...
        /// <summary>
        /// Returns the find logic as a Selenium By type
        /// </summary>
        ...
        /// </summary>
        public string FindLogicWithParameters { get; private set; }
        ...
        /// </summary>
        public string FriendlyNameWithParameters { get; private set; }
