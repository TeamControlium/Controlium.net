...
using TeamControlium.TestFramework;
    ...
    public class ControlBaseTester : ControlBase
    {
        ...
        public string Text
        {
            set
            {
                ...
                {
                    throw new TeamControlium.TestFramework.SeleniumExceptions.UnableToSetOrGetText(ObjectMap.TextEntryBox, $"Error finding, clearing or setting text [{value}] in [{RootElement.MappingDetails.FriendlyName}]", ex);
                }
            }
            get
            {
                ...
                {
                    throw new TeamControlium.TestFramework.SeleniumExceptions.UnableToSetOrGetText(ObjectMap.TextEntryBox, $"Error finding or getting text from textbox in [{RootElement.MappingDetails.FriendlyName}]", ex);
                }
            }
        }
