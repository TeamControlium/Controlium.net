...
namespace TeamControlium.TestFramework
{
    ...
    public partial class SeleniumDriver
    {
        ...
        public TimeSpan PageLoadTimeout
        {
            ...
            set
            {
                ...
                if (webDriver != null)
                {
                    ...
                    webDriver.Manage().Timeouts().SetPageLoadTimeout(pageLoadTimeout);
                }
            }
        }
        ...
        public void CloseDriver()
        {
            ...
            try
            {
                TakeScreenshotOption = Utilities.IsValueTrue(Utilities.TestData["Debug", "TakeScreenshot"]);
            }
            catch (Exception ex)
            {
        ...
        private void SetupLocalRun()
        {
            ...
            Utilities.TestData.TryGetItem(SeleniumLogFilename[0], SeleniumLogFilename[1], out seleniumDebugFile);
