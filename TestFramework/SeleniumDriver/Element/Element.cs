...
namespace TeamControlium.TestFramework
{
    public partial class Element
    {
        ...
        /// </summary>
        /// <exception cref="SeleniumExceptions.ElementCannotBeClicked">Thrown if element cannot be clicked or has not received the click event</exception>
        public void Click()
        {
            ThrowIfUnbound();
        ...
        public string GetAttribute(string Attribute)
        {
            ...
            if ((returnValue == null)) throw new SeleniumExceptions.AttributeReturnedNull(MappingDetails, Attribute);
            return returnValue;
        }
